...
public class ActivityReplay extends BaseActivity implements ITXLivePlayListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.benben.qcloud.benLive.R.layout.activity_replay);
    ...
    private void initView(){
        txvvPlayerView = (TXCloudVideoView)findViewById(com.benben.qcloud.benLive.R.id.txvv_play_view);
        tvLog = (TextView)findViewById(com.benben.qcloud.benLive.R.id.tv_log);
        tvCur = (TextView)findViewById(com.benben.qcloud.benLive.R.id.tv_play_cur);
        tvTotal = (TextView)findViewById(com.benben.qcloud.benLive.R.id.tv_play_total);
        sbProgress = (SeekBar)findViewById(com.benben.qcloud.benLive.R.id.sb_progress);
