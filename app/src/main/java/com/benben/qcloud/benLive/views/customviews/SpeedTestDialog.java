...
public class SpeedTestDialog {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case MSG_START:
                    ...
                    pd.setTitle(context.getString(com.benben.qcloud.benLive.R.string.ping_ing));
                    pd.setCancelable(false);
                    pd.setMessage(context.getString(com.benben.qcloud.benLive.R.string.ping_start));
                    pd.setButton(DialogInterface.BUTTON_NEGATIVE, context.getString(com.benben.qcloud.benLive.R.string.ping_cancel), new DialogInterface.OnClickListener() {
                        @Override
                ...
                case MSG_END:
                    ...
                    for (PingResult result : results){
                        ...
                        resultStr.append(context.getString(com.benben.qcloud.benLive.R.string.ping_time) + result.getUseTime() + "ms ");
                        resultStr.append(context.getString(com.benben.qcloud.benLive.R.string.ping_miss) + percentFormat.format((double)(result.getTotalPkg() - result.getReceivePkg())/(double)result.getTotalPkg()) + "\n");
                    }
    ...
    public void start(){
        TIMAvManager.getInstance().requestSpeedTest(new TIMPingCallBack() {
            ...
            public void onProgress(ServerInfo serverInfo, int totalPkg, int currentPkg) {
                ...
                bundle.putString("msg", serverInfoToString(serverInfo) + "(" + doneServer.size() + "/" + totalServer.size() + ")\n" + context.getString(com.benben.qcloud.benLive.R.string.ping_progress) + " " + currentPkg + "/" + totalPkg);
            ...
            public void onStart(List<ServerInfo> serverInfoList) {
                ...
                if (serverInfoList.size() > 0) {
                    ...
                    Toast.makeText(context, context.getString(com.benben.qcloud.benLive.R.string.ping_no_server), Toast.LENGTH_SHORT).show();
                }
    ...
    private String serverInfoToString(ServerInfo info){
        ...
        switch (info.idc){
            case SH:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_SH));
                break;
            case SZ:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_SZ));
                break;
            case CD:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_CD));
                break;
            case TJ:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_TJ));
                break;
            case NJ:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_NJ));
                break;
            case HZ:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_HZ));
                break;
            case GZ:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_GZ));
                break;
        ...
        switch (info.isp){
            case TEL:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_TEL));
                break;
            case CNC:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_CNC));
                break;
            case CMCC:
                str.append(context.getString(com.benben.qcloud.benLive.R.string.ping_CMCC));
                break;
        }
        return str.toString();
