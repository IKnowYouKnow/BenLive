...
public abstract class AbstractPathAnimator {
    ...
    public static class Config {
        ...
        static public Config fromTypeArray(TypedArray typedArray, float x, float y, int pointx, int heartWidth, int heartHeight) {
            ...
            config.initX = (int) typedArray.getDimension(com.benben.qcloud.benLive.R.styleable.HeartLayout_initX,
                    x);
            config.initY = (int) typedArray.getDimension(com.benben.qcloud.benLive.R.styleable.HeartLayout_initY,
                    y);
            config.xRand = (int) typedArray.getDimension(com.benben.qcloud.benLive.R.styleable.HeartLayout_xRand,
                    res.getDimensionPixelOffset(com.benben.qcloud.benLive.R.dimen.heart_anim_bezier_x_rand));
            config.animLength = (int) typedArray.getDimension(com.benben.qcloud.benLive.R.styleable.HeartLayout_animLength,
                    res.getDimensionPixelOffset(com.benben.qcloud.benLive.R.dimen.heart_anim_length));//动画长度
            config.animLengthRand = (int) typedArray.getDimension(com.benben.qcloud.benLive.R.styleable.HeartLayout_animLengthRand,
                    res.getDimensionPixelOffset(com.benben.qcloud.benLive.R.dimen.heart_anim_length_rand));
            config.bezierFactor = typedArray.getInteger(com.benben.qcloud.benLive.R.styleable.HeartLayout_bezierFactor,
                    res.getInteger(com.benben.qcloud.benLive.R.integer.heart_anim_bezier_factor));
...
//                    res.getDimensionPixelOffset(R.dimen.heart_size_height));//动画图片高度
            ...
            config.animDuration = typedArray.getInteger(com.benben.qcloud.benLive.R.styleable.HeartLayout_anim_duration,
                    res.getInteger(com.benben.qcloud.benLive.R.integer.anim_duration));//持续期
            return config;
        }
