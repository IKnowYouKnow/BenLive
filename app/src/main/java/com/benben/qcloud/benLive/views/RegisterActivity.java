...
public class RegisterActivity extends BaseActivity implements View.OnClickListener, LoginView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.benben.qcloud.benLive.R.layout.activity_independent_register);
        ...
        mRepassword = (EditText) findViewById(com.benben.qcloud.benLive.R.id.repassword);
        mBtnRegister = (TextView) findViewById(com.benben.qcloud.benLive.R.id.btn_register);
        mBtnBack = (ImageButton) findViewById(com.benben.qcloud.benLive.R.id.back);
